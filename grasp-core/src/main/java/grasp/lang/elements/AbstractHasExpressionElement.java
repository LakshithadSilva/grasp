 ...
 * IHasExpression. This class inherits from AbstractElement, and
 * provide base implementation for elements that are not first-class.
 * 
...
abstract class AbstractHasExpressionElement extends AbstractElement implements IHasExpression {
	//
	// Fields
	//
	...
	// Constructor
	//
	public AbstractHasExpressionElement(ElementSpecifier elementSpecifier) {
		super(elementSpecifier);
	}
